...
How much must be added to a [minimal language](../../2025/03/01.md) like lambda calculus to write practical programs in it, such as a static site generator? Turns out, not much, if you add data types and more importantly, _effects and effect handlers_.
