...
(This note continues the explorations of [part 1](../../2025/07/06.md) and [part 2](../../2025/08/05.md) but is self-contained. There's also a [paper](../../../papers/reasonable-macros-through-explicit-bindings-v2.pdf) that goes into more technical detail.)
